...
knitr::opts_knit$set(root.dir = "Users/Jules/Documents/UMich_Bio201_F19/Lab2/")
```
...
```{r}
2.54 * height_in #inches to centimeters conversion factor
```
...
What do you think is the current content of the object height_cm? 182.88 or 167.44? 167.44
What do you think is the current content of the object height_in? 72 or 66? 72
...
age  <- age + 20        # age? 41
mass_index <- mass/age # mass_index? 3.980488
```
...
```{r}
round(3.14159)
ceiling(3.14159) #playing around
...
# Why do you think it happens? Four is treated as a character because of the quotation marks surrounding it
```
...
study_semesters <- c("Winter 2015", "Fall 2015", "Winter 2016", "Fall 2016", "Winter 2017", "Fall 2017", "Winter 2018", "Fall 2018", "Winter 2019", "Fall 2019")
# Build a vector where the supplements consumed matches the order of the study semesters: 
supplements_during_study_semester <- c("RPS", "RMS, RPS, Inulin, Arabinoxylan", "Psyllium", "RPS", "RMS, Inulin, Accessible", "RPS, HiMaize, banana", "HiMaize", "RPS, RMS", "RPS", "RPS, oat, rice, potato")
# What type are each of these? character vectors

```

```{r}
# Build a vector of the typical age of college students:
typical_college_student_age_years <- c(18, 19, 20, 21)
# Confirm this is numeric
str(typical_college_student_age_years) #Confirmed
# Convert this vector to character:
typical_college_student_age_years_character <- c("18", "19", "20", "21")
...
mean(pH_1, digits = 2) != mean(pH_2, digits = 2) #True

#These values do not equal
